        ...
        <div class="col-md-10">
            ...
            <br><br>
                ...
                <form action="{{ route('update-list') }}" method="POST" enctype="multipart/form-data" contentType='application/json'>
                    @csrf
                    <label for="recperpage">Choose # of entries:</label>
                ...
                <div class="card-body">
                    ...
                    <thead class="thead-dark">
                        <tr>
                            <th class="tg-ul38">company</th>
                            <th class="tg-ul38">item code</th>
                            <th class="tsvag-ul38">item</th>
                            <th class="tg-ul38 currency">item cost</th>
                            <th class="tg-ul38">quantity</th>
                            <th class="tg-ul38">cost type</th>
                            <th class="tg-ul38 currency">unit cost</th>
                        </tr>
                    </thead>
